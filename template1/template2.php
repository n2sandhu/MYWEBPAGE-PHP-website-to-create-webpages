...
<body style="background: url(<?php echo $img_src; ?>) no-repeat center center fixed;">
    ...
    <div class="business-header" style="background: url(<?php echo $img_src1; ?>) no-repeat center center fixed;">
        <div class="container">

            <div class="row">
                <div class="col-lg-12">
                    <!-- The background image is set in the custom CSS -->
                    <h1 class="tagline"><?php echo $location; ?></h1>
                </div>
            </div>
    ...
    <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand"><?php echo $location; ?></a>
            </div>
...
<div class="container">
		...
		<div class="box">
			...
			<div class="col-lg-4 col-sm-4">
                ...
                <p><i><?php if ($catchPhrase == null) {
                    echo "The Place to see";
                    }
                    else
                    { echo $catchPhrase;} ?></i></p>
