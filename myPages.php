      ...
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
          <ul class="nav navbar-nav side-nav">
            ...
            <li class="active"><a href="myPages.php"><i class="fa fa-font"></i> Manage my Pages </a></li>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                            ...
                                            $result = mysql_query("SELECT * FROM website WHERE username = '$user' ");
                                            while($row = mysql_fetch_array($result))
                                            {
                                                ...
                                                $url = $row['webUrl'];
                                                echo "<td class='center'><a href='$url'>".$row['webUrl']."</a></td>";
                                                echo "<td>".$row['created']."</td>";
                                                echo "<td><input type='hidden' name='namely' value='$name' />";
                                                echo "<input type='hidden' name='filename' value='$filename' />";
                                                echo "<input class = 'btn btn-primary' type='submit' value='Edit'/></td>";
