      ...
      <div class="col-lg-6">
        ...
        <form role = "form" id="form1" action = "" method = "POST">
          ...
          <div class="form-group">
            ...
            <input class="form-control" name="location" value='<?php echo $location ?>' readonly >
            <p class="help-block">Example: Bundoora, Epping, Lower Plenty</p>
          </div>

          <div class="form-group">
            <label>Catch Phrase</label>
            <input type="text" class="form-control" name="catchPhrase" value='<?php echo $catchPhrase ?>' readonly>
            <p class="help-block">Example and By default: <i>The Place To Be</i></p>
          </div>

          <div class="form-group">
            <label>Description *</label>
            <textarea class="form-control" rows="3" name="Description" readonly> <?php echo $description ?> </textarea>
        ...
        <div class="col-lg-6">
          ...
          <div class="form-group row text-center">
            ...
            <input type="hiden" class="form-control" name="bg" id="img" value=<?php echo $img_src ?>>
          </div>
          ...
          <div class="col-sm-4 text-center">
            ...
            <input type="hiden" class="form-control" name="ad1" id="ad1" value="<?php echo $ad1; ?>" >
            <input type="hiden" class="form-control" name="ad1desc" id="ad1desc" value="<?php echo $ad2desc; ?>" >
            <input type="hiden" class="form-control" name="ad2" id="ad2" value="<?php echo $ad2; ?>" >
            <input type="hiden" class="form-control" name="ad2desc" id="ad2desc" value="<?php echo $ad2desc; ?>" >
